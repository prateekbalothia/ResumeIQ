...
export default function Home() {
  ...
  return (
    <ClickSpark
      ...
      duration={450}
    >
      <main className="flex-1 flex items-center justify-center bg-background text-foreground px-4 sm:px-6 pt-24 sm:pt-28 pb-8 relative overflow-hidden">
        ...
        <div className="max-w-3xl text-center relative z-10 w-full">
          ...
          <div className="mt-12 sm:mt-16 md:mt-20 grid md:grid-cols-3 gap-4 sm:gap-6">
